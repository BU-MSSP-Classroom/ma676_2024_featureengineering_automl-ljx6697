...
```{r,echo=TRUE}
ames_raw_2008$TotalSF <- ames_raw_2008$`Gr Liv Area` + ames_raw_2008$`1st Flr SF`
ames_raw_2009$TotalSF <- ames_raw_2009$`Gr Liv Area` + ames_raw_2009$`1st Flr SF`

lmfit_2008_with_FE <- lm(SalePrice ~ TotalSF, data = ames_raw_2008)
...
```{r,echo=TRUE}
predictions_original <- predict(lmfit_2008, newdata = ames_raw_2009)
MSE_original <- mean((predictions_original - ames_raw_2009$SalePrice)^2)
print(paste("MSE of the original model:", MSE_original))


predictions <- predict(lmfit_2008_with_FE, newdata = ames_raw_2009)
MSE <- mean((predictions - ames_raw_2009$SalePrice)^2)
print(paste("MSE of the model with feature engineering:", MSE))
```
...
The test MSE has been lower, so the feature engineering has some effect on the model improvement.
~~~
